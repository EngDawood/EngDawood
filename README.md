...
> Building MCP servers and LLM integrations that connect AI models to real-world tools

---

## What I Build

| MCP Development | AI Engineering |
|---|---|
| MCP servers & custom tools | LLM-powered applications |
| Claude & agent integrations | RAG pipelines & memory systems |
| Tool orchestration & workflows | AI automation & APIs |
